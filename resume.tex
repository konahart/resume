...
% Experience
\section{Experience}
\cventry{2018---Present}{Natural Language Processing Specialist}{Woebot Labs, Inc.}{San Francisco, CA}{}{
\begin{itemize}
\item Improved Natural Language Understanding in the Woebot chatbot
  \begin{itemize}
  \item Created a more naturalistic conversation experience for users
  \end{itemize}
\item Applied expertise in chatbot conversational design to existing product
  \begin{itemize}
  \item Identified common pitfalls and suggested solutions
...
\cvitem{\textbf{Tools}}{TensorFlow, FastText, NLTK, spaCy, Stanford CoreNLP, Git, Mercurial, Bash, \LaTeX }
